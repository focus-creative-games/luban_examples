...
local function InitTypes(methods)
    ...
    do
    ---@class blueprint.DValue 
        local class = SimpleClass()
        class._id = 904375112
        class._name = 'blueprint.DValue'
    ...
    do
    ---@class blueprint.DBool :blueprint.DValue 
     ---@field public value bool
        local class = SimpleClass()
        class._id = 1691159091
        class._name = 'blueprint.DBool'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            value = readBool(bs),
    ...
    do
    ---@class blueprint.DInt :blueprint.DValue 
     ---@field public value int
        local class = SimpleClass()
        class._id = 1578580870
        class._name = 'blueprint.DInt'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            value = readInt(bs),
    ...
    do
    ---@class blueprint.DLong :blueprint.DValue 
     ---@field public value long
        local class = SimpleClass()
        class._id = 1691456965
        class._name = 'blueprint.DLong'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            value = readLong(bs),
    ...
    do
    ---@class blueprint.DDouble :blueprint.DValue 
     ---@field public value double
        local class = SimpleClass()
        class._id = 1763679450
        class._name = 'blueprint.DDouble'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            value = readDouble(bs),
    ...
    do
    ---@class blueprint.DString :blueprint.DValue 
     ---@field public value string
        local class = SimpleClass()
        class._id = -2097315558
        class._name = 'blueprint.DString'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            value = readString(bs),
    ...
    do
    ---@class blueprint.DObject :blueprint.DValue 
     ---@field public type string
     ---@field public fields blueprint.FieldValue[]
        local class = SimpleClass()
        class._id = 2066269256
        class._name = 'blueprint.DObject'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            type = readString(bs),
            fields = readList(bs, beans['blueprint.FieldValue']._deserialize),
            }
            setmetatable(o, class)
            return o
        end
    ...
    do
    ---@class blueprint.DArray :blueprint.DValue 
     ---@field public element_type string
     ---@field public elements blueprint.DValue[]
        local class = SimpleClass()
        class._id = 885492784
        class._name = 'blueprint.DArray'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            element_type = readString(bs),
            elements = readList(bs, beans['blueprint.DValue']._deserialize),
            }
            setmetatable(o, class)
            return o
        end
    ...
    do
    ---@class blueprint.FieldValue 
     ---@field public name string
     ---@field public value blueprint.DValue
        local class = SimpleClass()
        class._id = -1013673230
        class._name = 'blueprint.FieldValue'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            name = readString(bs),
            value = beans['blueprint.DValue']._deserialize(bs),
            }
            setmetatable(o, class)
            return o
        end
    ...
    ---@class common.TimeOfDay 
     ...
     ---@field public second int
        local class = SimpleClass()
        class._id = -1728347371
        class._name = 'common.TimeOfDay'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            hour = readInt(bs),
    ...
    ---@class common.OneDayTimeRange 
     ...
     ---@field public end_time common.TimeOfDay
        local class = SimpleClass()
        class._id = 1628814743
        class._name = 'common.OneDayTimeRange'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            start_time = beans['common.TimeOfDay']._deserialize(bs),
            end_time = beans['common.TimeOfDay']._deserialize(bs),
            }
            setmetatable(o, class)
            return o
        end
    ...
    do
    ---@class item.ClothesProp 
     ---@field public prop_enum item.EClothesPropertyType
     ---@field public value int
        local class = SimpleClass()
        class._id = -614640304
        class._name = 'item.ClothesProp'
        local id2name = {  }
        class._deserialize = function(bs)
            local o = {
            prop_enum = readInt(bs),
            value = readInt(bs),
            }
            setmetatable(o, class)
            return o
    ...
    local tables =
    {
    { name='TbBlackboard', file='ai.TbBlackboard.bin', mode='map', index='name', value_type='ai.Blackboard' },
    { name='TbBehaviorTree', file='ai.TbBehaviorTree.bin', mode='map', index='id', value_type='ai.BehaviorTree' },
    { name='TbClazz', file='blueprint.TbClazz.bin', mode='map', index='name', value_type='blueprint.Clazz' },
    { name='TbDrop', file='bonus.TbDrop.bin', mode='map', index='id', value_type='bonus.DropInfo' },
    { name='TbGlobalConfig', file='common.TbGlobalConfig.bin', mode='one', value_type='common.GlobalConfig'},
    { name='TbDummy', file='common.TbDummy.bin', mode='map', index='id', value_type='common.Dummy' },
    { name='TbErrorInfo', file='error.TbErrorInfo.bin', mode='map', index='code', value_type='error.ErrorInfo' },
    { name='TbCodeInfo', file='error.TbCodeInfo.bin', mode='map', index='code', value_type='error.CodeInfo' },
