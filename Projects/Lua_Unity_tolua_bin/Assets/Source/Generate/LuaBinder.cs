...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("Bright");
		L.BeginModule("Serialization");
		Bright_Serialization_ByteBufWrap.Register(L);
		L.EndModule();
		L.EndModule();
		...
		L.RegFunction("Func_bytes_int_int_string", System_Func_bytes_int_int_string);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Func_bytes_int_int_string(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Func<byte[],int,int,string>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Func<byte[],int,int,string>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
