...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Func<byte[],int,int,string>), factory.System_Func_bytes_int_int_string);
		...
		DelegateTraits<System.Func<byte[],int,int,string>>.Init(factory.System_Func_bytes_int_int_string);
		...
		TypeTraits<System.Func<byte[],int,int,string>>.Init(factory.Check_System_Func_bytes_int_int_string);
		...
		StackTraits<System.Func<byte[],int,int,string>>.Push = factory.Push_System_Func_bytes_int_int_string;
	}
	...
	class System_Func_bytes_int_int_string_Event : LuaDelegate
	{
		public System_Func_bytes_int_int_string_Event(LuaFunction func) : base(func) { }
		public System_Func_bytes_int_int_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public string Call(byte[] param0, int param1, int param2)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public string CallWithSelf(byte[] param0, int param1, int param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Func<byte[],int,int,string> System_Func_bytes_int_int_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Func<byte[],int,int,string> fn = delegate(byte[] param0, int param1, int param2) { return null; };
			return fn;
		}

		if(!flag)
		{
			System_Func_bytes_int_int_string_Event target = new System_Func_bytes_int_int_string_Event(func);
			System.Func<byte[],int,int,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Func_bytes_int_int_string_Event target = new System_Func_bytes_int_int_string_Event(func, self);
			System.Func<byte[],int,int,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Func_bytes_int_int_string(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Func<byte[],int,int,string>), L, pos);
	}

	void Push_System_Func_bytes_int_int_string(IntPtr L, System.Func<byte[],int,int,string> o)
	{
		ToLua.Push(L, o);
	}
