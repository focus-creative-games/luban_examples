...
public final class ChooseTarget extends cfg.ai.Service {
    public ChooseTarget(JsonObject __json__) { 
        super(__json__);
        resultTargetKey = __json__.get("result_target_key").getAsString();
    }
    ...
    public static ChooseTarget deserializeChooseTarget(JsonObject __json__) {
        return new ChooseTarget(__json__);
    }
