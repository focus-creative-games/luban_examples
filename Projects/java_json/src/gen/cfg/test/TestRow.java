...
public final class TestRow {
    public TestRow(JsonObject __json__) { 
        ...
        { var _json0_ = __json__.get("b").getAsJsonArray(); b = new java.util.ArrayList<Integer>(_json0_.size()); for(JsonElement __e : _json0_) { int __v;  __v = __e.getAsInt();  b.add(__v); }   }
    }
