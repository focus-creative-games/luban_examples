...
public final class DemoType2 {
    public DemoType2(JsonObject __json__) { 
        ...
        { var _json0_ = __json__.get("k2").getAsJsonArray(); k2 = new java.util.ArrayList<Integer>(_json0_.size()); for(JsonElement __e : _json0_) { int __v;  __v = __e.getAsInt();  k2.add(__v); }   }
        { var _json0_ = __json__.get("k5").getAsJsonArray(); k5 = new java.util.HashSet<Integer>(_json0_.size()); for(JsonElement __e : _json0_) { int __v;  __v = __e.getAsInt();  k5.add(__v); }   }
