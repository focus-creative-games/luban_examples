...
public final class MultiRowRecord {
    public MultiRowRecord(JsonObject __json__) { 
        ...
        { var _json0_ = __json__.get("multi_rows3").getAsJsonArray(); multiRows3 = new java.util.HashSet<cfg.test.MultiRowType2>(_json0_.size()); for(JsonElement __e : _json0_) { cfg.test.MultiRowType2 __v;  __v = new cfg.test.MultiRowType2(__e.getAsJsonObject());  multiRows3.add(__v); }   }
