...
public final class MultiRowRecord {
    public MultiRowRecord(JsonObject __json__) { 
        ...
        { var _json0_ = __json__.get("one_rows").getAsJsonArray(); oneRows = new java.util.ArrayList<cfg.test.MultiRowType1>(_json0_.size()); for(JsonElement __e : _json0_) { cfg.test.MultiRowType1 __v;  __v = new cfg.test.MultiRowType1(__e.getAsJsonObject());  oneRows.add(__v); }   }
        { var _json0_ = __json__.get("multi_rows1").getAsJsonArray(); multiRows1 = new java.util.ArrayList<cfg.test.MultiRowType1>(_json0_.size()); for(JsonElement __e : _json0_) { cfg.test.MultiRowType1 __v;  __v = new cfg.test.MultiRowType1(__e.getAsJsonObject());  multiRows1.add(__v); }   }
        { var _json0_ = __json__.get("multi_rows2").getAsJsonArray(); int _n = _json0_.size(); multiRows2 = new cfg.test.MultiRowType1[_n]; int _index=0; for(JsonElement __e : _json0_) { cfg.test.MultiRowType1 __v;  __v = new cfg.test.MultiRowType1(__e.getAsJsonObject());  multiRows2[_index++] = __v; }   }
        { var _json0_ = __json__.get("multi_rows4").getAsJsonArray(); multiRows4 = new java.util.HashMap<Integer, cfg.test.MultiRowType2>(_json0_.size()); for(JsonElement __e : _json0_) { int __k;  __k = __e.getAsJsonArray().get(0).getAsInt(); cfg.test.MultiRowType2 __v;  __v = new cfg.test.MultiRowType2(__e.getAsJsonArray().get(1).getAsJsonObject());  multiRows4.put(__k, __v); }   }
        { var _json0_ = __json__.get("multi_rows5").getAsJsonArray(); multiRows5 = new java.util.ArrayList<cfg.test.MultiRowType3>(_json0_.size()); for(JsonElement __e : _json0_) { cfg.test.MultiRowType3 __v;  __v = new cfg.test.MultiRowType3(__e.getAsJsonObject());  multiRows5.add(__v); }   }
        { var _json0_ = __json__.get("multi_rows6").getAsJsonArray(); multiRows6 = new java.util.HashMap<Integer, cfg.test.MultiRowType2>(_json0_.size()); for(JsonElement __e : _json0_) { int __k;  __k = __e.getAsJsonArray().get(0).getAsInt(); cfg.test.MultiRowType2 __v;  __v = new cfg.test.MultiRowType2(__e.getAsJsonArray().get(1).getAsJsonObject());  multiRows6.put(__k, __v); }   }
        { var _json0_ = __json__.get("multi_rows7").getAsJsonArray(); multiRows7 = new java.util.HashMap<Integer, Integer>(_json0_.size()); for(JsonElement __e : _json0_) { int __k;  __k = __e.getAsJsonArray().get(0).getAsInt(); int __v;  __v = __e.getAsJsonArray().get(1).getAsInt();  multiRows7.put(__k, __v); }   }
    }
