...
public final class Items extends cfg.bonus.Bonus {
    public Items(JsonObject __json__) { 
        super(__json__);
        { var _json0_ = __json__.get("item_list").getAsJsonArray(); int _n = _json0_.size(); itemList = new cfg.bonus.Item[_n]; int _index=0; for(JsonElement __e : _json0_) { cfg.bonus.Item __v;  __v = new cfg.bonus.Item(__e.getAsJsonObject());  itemList[_index++] = __v; }   }
    }
