...
public final class ProbabilityBonus extends cfg.bonus.Bonus {
    public ProbabilityBonus(JsonObject __json__) { 
        super(__json__);
        { var _json0_ = __json__.get("bonuses").getAsJsonArray(); int _n = _json0_.size(); bonuses = new cfg.bonus.ProbabilityBonusInfo[_n]; int _index=0; for(JsonElement __e : _json0_) { cfg.bonus.ProbabilityBonusInfo __v;  __v = new cfg.bonus.ProbabilityBonusInfo(__e.getAsJsonObject());  bonuses[_index++] = __v; }   }
    }
