...
public final class BlueprintMethod extends cfg.blueprint.Method {
    public BlueprintMethod(JsonObject __json__) { 
        super(__json__);
    }
    ...
    public static BlueprintMethod deserializeBlueprintMethod(JsonObject __json__) {
        return new BlueprintMethod(__json__);
    }
