...
public final class EnumClazz extends cfg.blueprint.Clazz {
    public EnumClazz(JsonObject __json__) { 
        super(__json__);
        { com.google.gson.JsonArray _json0_ = __json__.get("enums").getAsJsonArray(); enums = new java.util.ArrayList<cfg.blueprint.EnumField>(_json0_.size()); for(JsonElement _e0 : _json0_) { cfg.blueprint.EnumField _v0;  _v0 = new cfg.blueprint.EnumField(_e0.getAsJsonObject());  enums.add(_v0); }   }
    }
