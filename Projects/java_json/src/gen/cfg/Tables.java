...
public final class Tables
{
    ...
    public Tables(IJsonLoader loader) throws java.io.IOException {
        ...
        _TbBlackboard = new cfg.ai.TbBlackboard(loader.load("ai.TbBlackboard")); 
        tables.put("ai.TbBlackboard", _TbBlackboard);
        _TbBehaviorTree = new cfg.ai.TbBehaviorTree(loader.load("ai.TbBehaviorTree")); 
        tables.put("ai.TbBehaviorTree", _TbBehaviorTree);
        _TbClazz = new cfg.blueprint.TbClazz(loader.load("blueprint.TbClazz")); 
        tables.put("blueprint.TbClazz", _TbClazz);
        _TbDrop = new cfg.bonus.TbDrop(loader.load("bonus.TbDrop")); 
        tables.put("bonus.TbDrop", _TbDrop);
        _TbGlobalConfig = new cfg.common.TbGlobalConfig(loader.load("common.TbGlobalConfig")); 
        tables.put("common.TbGlobalConfig", _TbGlobalConfig);
        _TbDummy = new cfg.common.TbDummy(loader.load("common.TbDummy")); 
        tables.put("common.TbDummy", _TbDummy);
        _TbErrorInfo = new cfg.error.TbErrorInfo(loader.load("error.TbErrorInfo")); 
        tables.put("error.TbErrorInfo", _TbErrorInfo);
        _TbCodeInfo = new cfg.error.TbCodeInfo(loader.load("error.TbCodeInfo")); 
        tables.put("error.TbCodeInfo", _TbCodeInfo);
        _TbItem = new cfg.item.TbItem(loader.load("item.TbItem")); 
        tables.put("item.TbItem", _TbItem);
        _TbItemFunc = new cfg.item.TbItemFunc(loader.load("item.TbItemFunc")); 
        tables.put("item.TbItemFunc", _TbItemFunc);
        _TbItemExtra = new cfg.item.TbItemExtra(loader.load("item.TbItemExtra")); 
        tables.put("item.TbItemExtra", _TbItemExtra);
        _TbL10NDemo = new cfg.l10n.TbL10NDemo(loader.load("l10n.TbL10NDemo")); 
        tables.put("l10n.TbL10NDemo", _TbL10NDemo);
        _TbPatchDemo = new cfg.l10n.TbPatchDemo(loader.load("l10n.TbPatchDemo")); 
        tables.put("l10n.TbPatchDemo", _TbPatchDemo);
        _TbSystemMail = new cfg.mail.TbSystemMail(loader.load("mail.TbSystemMail")); 
        tables.put("mail.TbSystemMail", _TbSystemMail);
        _TbGlobalMail = new cfg.mail.TbGlobalMail(loader.load("mail.TbGlobalMail")); 
        tables.put("mail.TbGlobalMail", _TbGlobalMail);
        _TbRoleLevelExpAttr = new cfg.role.TbRoleLevelExpAttr(loader.load("role.TbRoleLevelExpAttr")); 
        tables.put("role.TbRoleLevelExpAttr", _TbRoleLevelExpAttr);
        _TbRoleLevelBonusCoefficient = new cfg.role.TbRoleLevelBonusCoefficient(loader.load("role.TbRoleLevelBonusCoefficient")); 
        tables.put("role.TbRoleLevelBonusCoefficient", _TbRoleLevelBonusCoefficient);
        _TbTestTag = new cfg.tag.TbTestTag(loader.load("tag.TbTestTag")); 
        tables.put("tag.TbTestTag", _TbTestTag);
        _TbFullTypes = new cfg.test.TbFullTypes(loader.load("test.TbFullTypes")); 
        tables.put("test.TbFullTypes", _TbFullTypes);
        _TbSingleton = new cfg.test.TbSingleton(loader.load("test.TbSingleton")); 
        tables.put("test.TbSingleton", _TbSingleton);
        _TbDataFromMisc = new cfg.test.TbDataFromMisc(loader.load("test.TbDataFromMisc")); 
        tables.put("test.TbDataFromMisc", _TbDataFromMisc);
        _TbMultiRowRecord = new cfg.test.TbMultiRowRecord(loader.load("test.TbMultiRowRecord")); 
        tables.put("test.TbMultiRowRecord", _TbMultiRowRecord);
        _TbMultiRowTitle = new cfg.test.TbMultiRowTitle(loader.load("test.TbMultiRowTitle")); 
        tables.put("test.TbMultiRowTitle", _TbMultiRowTitle);
        _TbTestNull = new cfg.test.TbTestNull(loader.load("test.TbTestNull")); 
        tables.put("test.TbTestNull", _TbTestNull);
        _TbDemoPrimitive = new cfg.test.TbDemoPrimitive(loader.load("test.TbDemoPrimitive")); 
        tables.put("test.TbDemoPrimitive", _TbDemoPrimitive);
        _TbTestString = new cfg.test.TbTestString(loader.load("test.TbTestString")); 
        tables.put("test.TbTestString", _TbTestString);
        _TbDemoGroup = new cfg.test.TbDemoGroup(loader.load("test.TbDemoGroup")); 
        tables.put("test.TbDemoGroup", _TbDemoGroup);
        _TbDemoGroup_C = new cfg.test.TbDemoGroup_C(loader.load("test.TbDemoGroup_C")); 
        tables.put("test.TbDemoGroup_C", _TbDemoGroup_C);
        _TbDemoGroup_S = new cfg.test.TbDemoGroup_S(loader.load("test.TbDemoGroup_S")); 
        tables.put("test.TbDemoGroup_S", _TbDemoGroup_S);
        _TbDemoGroup_E = new cfg.test.TbDemoGroup_E(loader.load("test.TbDemoGroup_E")); 
        tables.put("test.TbDemoGroup_E", _TbDemoGroup_E);
        _TbTestGlobal = new cfg.test.TbTestGlobal(loader.load("test.TbTestGlobal")); 
        tables.put("test.TbTestGlobal", _TbTestGlobal);
        _TbDetectCsvEncoding = new cfg.test.TbDetectCsvEncoding(loader.load("test.TbDetectCsvEncoding")); 
        tables.put("test.TbDetectCsvEncoding", _TbDetectCsvEncoding);
        _TbDefineFromExcel = new cfg.test.TbDefineFromExcel(loader.load("test.TbDefineFromExcel")); 
        tables.put("test.TbDefineFromExcel", _TbDefineFromExcel);
        _TbDefineFromExcelOne = new cfg.test.TbDefineFromExcelOne(loader.load("test.TbDefineFromExcelOne")); 
        tables.put("test.TbDefineFromExcelOne", _TbDefineFromExcelOne);
        _TbTestJson2 = new cfg.test.TbTestJson2(loader.load("test.TbTestJson2")); 
        tables.put("test.TbTestJson2", _TbTestJson2);
        _TbTestIndex = new cfg.test.TbTestIndex(loader.load("test.TbTestIndex")); 
        tables.put("test.TbTestIndex", _TbTestIndex);
        _TbTestMap = new cfg.test.TbTestMap(loader.load("test.TbTestMap")); 
        tables.put("test.TbTestMap", _TbTestMap);
        _TbDemoGroupDefineFromExcel = new cfg.test.TbDemoGroupDefineFromExcel(loader.load("test.TbDemoGroupDefineFromExcel")); 
        tables.put("test.TbDemoGroupDefineFromExcel", _TbDemoGroupDefineFromExcel);
        _TbDefineFromExcel2 = new cfg.test.TbDefineFromExcel2(loader.load("test.TbDefineFromExcel2")); 
        tables.put("test.TbDefineFromExcel2", _TbDefineFromExcel2);
        _TbTestExcelBean = new cfg.test.TbTestExcelBean(loader.load("test.TbTestExcelBean")); 
