...
export class GlobalConfig {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        { this.x7 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :number; _e = _buf_.ReadInt(); this.x7.push(_e) } }
    }
...
export class DemoType2 {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k1 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.k1[i] = _e } }
        ...
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k15 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :test.DemoDynamic;_e = test.DemoDynamic.constructorFrom(_buf_); this.k15.push(_e) } }
    }
...
export class MultiRowRecord {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.multiRows2 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :test.MultiRowType1;_e = new test.MultiRowType1(_buf_); this.multiRows2.push(_e) } }
...
export class MultiRowTitle {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.x3 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :test.H2;_e = new test.H2(_buf_); this.x3.push(_e) } }
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.x4 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :test.H2;_e = new test.H2(_buf_); this.x4.push(_e) } }
    }
...
export class RefBean extends test.RefDynamicBase {
    ...
    constructor(_buf_: ByteBuf) {
        super(_buf_)
        { this.arr = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :number; _e = _buf_.ReadInt(); this.arr.push(_e) } }
    }
...
export class TestRef {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        this.x3 = _buf_.ReadInt()
        this.x4 = _buf_.ReadInt()
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.a1 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.a1[i] = _e } }
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.a2 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.a2[i] = _e } }
...
export class TestSize {
    ...
    constructor(_buf_: ByteBuf) {
        this.id = _buf_.ReadInt()
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.x1 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.x1[i] = _e } }
...
export class DefineFromExcel2 {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        this.t1 = _buf_.ReadLongAsNumber()
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k1 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.k1[i] = _e } }
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k2 = new Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.k2[i] = _e } }
        { this.k8 = new Map<number, number>(); for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _k:number; _k = _buf_.ReadInt(); let _v:number; _v = _buf_.ReadInt(); this.k8.set(_k, _v);  } }
        { this.k9 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.DemoE2; _e = new test.DemoE2(_buf_); this.k9.push(_e) } }
        { this.k10 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :vec3; _e = new vec3(_buf_); this.k10.push(_e) } }
        { this.k11 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :vec4; _e = new vec4(_buf_); this.k11.push(_e) } }
...
export class TbBlackboard{
    ...
    get(key: string): ai.Blackboard | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbBlackboard ${key} not found`);
        } 
...
export class TbBehaviorTree{
    ...
    get(key: number): ai.BehaviorTree | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbBehaviorTree ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbItem{
    ...
    get(key: number): item.Item | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbItem ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbL10NDemo{
    ...
    get(key: number): l10n.L10NDemo | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbL10NDemo ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbPatchDemo{
    ...
    get(key: number): l10n.PatchDemo | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbPatchDemo ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestTag{
    ...
    get(key: number): tag.TestTag | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestTag ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbFullTypes{
    ...
    get(key: number): test.DemoType2 | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbFullTypes ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDataFromMisc{
    ...
    get(key: number): test.DemoType2 | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDataFromMisc ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbMultiRowRecord{
    ...
    get(key: number): test.MultiRowRecord | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbMultiRowRecord ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestMultiColumn{
    ...
    get(key: number): test.TestMultiColumn | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestMultiColumn ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbMultiRowTitle{
    ...
    get(key: number): test.MultiRowTitle | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbMultiRowTitle ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestNull{
    ...
    get(key: number): test.TestNull | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestNull ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDemoPrimitive{
    ...
    get(key: number): test.DemoPrimitiveTypesTable | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDemoPrimitive ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestString{
    ...
    get(key: string): test.TestString | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestString ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDemoGroup{
    ...
    get(key: number): test.DemoGroup | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDemoGroup ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDemoGroup_C{
    ...
    get(key: number): test.DemoGroup | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDemoGroup_C ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDemoGroup_S{
    ...
    get(key: number): test.DemoGroup | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDemoGroup_S ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDemoGroup_E{
    ...
    get(key: number): test.DemoGroup | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDemoGroup_E ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestBeRef{
    ...
    get(key: number): test.TestBeRef | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestBeRef ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestBeRef2{
    ...
    get(key: number): test.TestBeRef | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestBeRef2 ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestRef{
    ...
    get(key: number): test.TestRef | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestRef ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestSize{
    ...
    get(key: number): test.TestSize | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestSize ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestSet{
    ...
    get(key: number): test.TestSet | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestSet ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDetectCsvEncoding{
    ...
    get(key: number): test.DetectEncoding | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDetectCsvEncoding ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbItem2{
    ...
    get(key: number): test.ItemBase | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbItem2 ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestIndex{
    ...
    get(key: number): test.TestIndex | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestIndex ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestMap{
    ...
    get(key: number): test.TestMap | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestMap ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbExcelFromJson{
    ...
    get(key: number): test.ExcelFromJson | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbExcelFromJson ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbCompositeJsonTable1{
    ...
    get(key: number): test.CompositeJsonTable1 | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbCompositeJsonTable1 ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbCompositeJsonTable2{
    ...
    get(key: number): test.CompositeJsonTable2 | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbCompositeJsonTable2 ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbExcelFromJsonMultiRow{
    ...
    get(key: number): test.ExcelFromJsonMultiRow | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbExcelFromJsonMultiRow ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestScriptableObject{
    ...
    get(key: number): test.TestScriptableObject | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestScriptableObject ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbPath{
    ...
    get(key: number): test.Path | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbPath ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbTestMapper{
    ...
    get(key: number): test.TestMapper | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbTestMapper ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
...
export class TbDefineFromExcel2{
    private _dataMap: Map<number, DefineFromExcel2>
    private _dataList: DefineFromExcel2[]
    constructor(_buf_: ByteBuf) {
        this._dataMap = new Map<number, DefineFromExcel2>()
        this._dataList = []
        for(let n = _buf_.ReadInt(); n > 0; n--) {
            let _v: DefineFromExcel2
            _v = new DefineFromExcel2(_buf_)
            this._dataList.push(_v)
            this._dataMap.set(_v.id, _v)
        }
    }

    getDataMap(): Map<number, DefineFromExcel2> { return this._dataMap; }
    getDataList(): DefineFromExcel2[] { return this._dataList; }

    get(key: number): DefineFromExcel2 | undefined {
        if (!this._dataMap.has(key)) {
            console.error(`TbDefineFromExcel2 ${key} not found`);
        } 
        return this._dataMap.get(key); 
    }
