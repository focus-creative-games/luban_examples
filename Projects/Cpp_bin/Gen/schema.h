...
struct GlobalConfig : public luban::CfgBean 
{
     ...
     * 背包容量
     */
    ::luban::int32 bagCapacity;
    ::luban::int32 bagCapacitySpecial;
    ::luban::int32 bagTempExpendableCapacity;
    ::luban::int32 bagTempToolCapacity;
    ::luban::int32 bagInitCapacity;
    ::luban::int32 quickBagCapacity;
    ::luban::int32 clothBagCapacity;
    ::luban::int32 clothBagInitCapacity;
    ::luban::int32 clothBagCapacitySpecial;
    ::luban::SharedPtr<::luban::int32> bagInitItemsDropId;
    ::luban::int32 mailBoxCapacity;
    ::luban::float32 damageParamC;
    ::luban::float32 damageParamE;
    ::luban::float32 damageParamF;
    ::luban::float32 damageParamD;
    ::luban::float32 roleSpeed;
    ::luban::float32 monsterSpeed;
    ::luban::int32 initEnergy;
    ::luban::int32 initViality;
    ::luban::int32 maxViality;
    ::luban::int32 perVialityRecoveryTime;
...
class TbGlobalConfig
{
     ...
     * 背包容量
     */
    ::luban::int32& getBagCapacity() const { return _data->bagCapacity; }
    ::luban::int32& getBagCapacitySpecial() const { return _data->bagCapacitySpecial; }
    ::luban::int32& getBagTempExpendableCapacity() const { return _data->bagTempExpendableCapacity; }
    ::luban::int32& getBagTempToolCapacity() const { return _data->bagTempToolCapacity; }
    ::luban::int32& getBagInitCapacity() const { return _data->bagInitCapacity; }
    ::luban::int32& getQuickBagCapacity() const { return _data->quickBagCapacity; }
    ::luban::int32& getClothBagCapacity() const { return _data->clothBagCapacity; }
    ::luban::int32& getClothBagInitCapacity() const { return _data->clothBagInitCapacity; }
    ::luban::int32& getClothBagCapacitySpecial() const { return _data->clothBagCapacitySpecial; }
    ::luban::SharedPtr<::luban::int32>& getBagInitItemsDropId() const { return _data->bagInitItemsDropId; }
    ::luban::int32& getMailBoxCapacity() const { return _data->mailBoxCapacity; }
    ::luban::float32& getDamageParamC() const { return _data->damageParamC; }
    ::luban::float32& getDamageParamE() const { return _data->damageParamE; }
    ::luban::float32& getDamageParamF() const { return _data->damageParamF; }
    ::luban::float32& getDamageParamD() const { return _data->damageParamD; }
    ::luban::float32& getRoleSpeed() const { return _data->roleSpeed; }
    ::luban::float32& getMonsterSpeed() const { return _data->monsterSpeed; }
    ::luban::int32& getInitEnergy() const { return _data->initEnergy; }
    ::luban::int32& getInitViality() const { return _data->initViality; }
    ::luban::int32& getMaxViality() const { return _data->maxViality; }
    ::luban::int32& getPerVialityRecoveryTime() const { return _data->perVialityRecoveryTime; }
};
