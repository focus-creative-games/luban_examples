...
namespace bright
{
    namespace serialization
    {
        ...
        public:
            ...
            void writeVector2(bright::math::Vector2& v)
            {
                writeFloat(v.x);
                writeFloat(v.y);
            }

            bool readVector2(bright::math::Vector2& out)
            {
                return readFloat(out.x) && readFloat(out.y);
            }

            void writeVector3(bright::math::Vector3& v)
            {
                writeFloat(v.x);
                writeFloat(v.y);
                writeFloat(v.z);
            ...
            bool readVector3(bright::math::Vector3& out)
            {
                return readFloat(out.x) && readFloat(out.y) && readFloat(out.z);
            }

            void writeVector4(bright::math::Vector4& v)
            {
                writeFloat(v.x);
                writeFloat(v.y);
                writeFloat(v.z);
            ...
            bool readVector4(bright::math::Vector4& out)
            {
                return readFloat(out.x) && readFloat(out.y) && readFloat(out.z) && readFloat(out.w);
            }
            ...
            bool readBytes(Bytes*& out)
            {
                ...
                if (n > 0)
                {
                    if (!ensureRead(n)) return false;
                    Bytes* x = new Bytes(n);
                    std::memcpy(x->data(), this->getReadData(), n);
                    beginPos_ += n;
                    out = x;
                }
                else
