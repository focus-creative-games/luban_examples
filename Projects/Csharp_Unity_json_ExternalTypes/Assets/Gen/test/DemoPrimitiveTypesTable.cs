...
public sealed partial class DemoPrimitiveTypesTable :  Bright.Config.BeanBase 
{
    ...
    public DemoPrimitiveTypesTable(bool x1, byte x2, short x3, int x4, long x5, float x6, double x7, string s1, string s2, System.Numerics.Vector2 v2, UnityEngine.Vector3 v3, UnityEngine.Vector4 v4, System.DateTime t1 ) 
    {
        this.X1 = x1;
        this.X2 = x2;
        this.X3 = x3;
