...
public sealed partial class DefineFromExcel :  Bright.Config.BeanBase 
{
    ...
    public DefineFromExcel(int id, bool x1, long x5, float x6, int x8, string x10, test.ETestQuality x13, test.DemoDynamic x14, test.Shape x15, System.Numerics.Vector2 v2, System.DateTime t1, int[] k1, int[] k2, System.Collections.Generic.Dictionary<int, int> k8, System.Collections.Generic.List<test.DemoE2> k9 ) 
    {
        this.Id = id;
        this.X1 = x1;
        this.X5 = x5;
