...
public struct TestDefineFromExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static TestDefineFromExcel GetRootAsTestDefineFromExcel(ByteBuffer _bb) { return GetRootAsTestDefineFromExcel(_bb, new TestDefineFromExcel()); }
  public static TestDefineFromExcel GetRootAsTestDefineFromExcel(ByteBuffer _bb, TestDefineFromExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TestDefineFromExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void StartTestDefineFromExcel(FlatBufferBuilder builder) { builder.StartTable(14); }
  ...
  public static Offset<cfg.TestDefineFromExcel> EndTestDefineFromExcel(FlatBufferBuilder builder) {
    ...
    return new Offset<cfg.TestDefineFromExcel>(o);
  }
};
