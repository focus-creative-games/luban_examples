...
namespace cfg.test
{
    public partial class TbTestScriptableObject
    {
        ...
        public TbTestScriptableObject(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestScriptableObject> onLoad = null)
        {
        ...
        public test.TestScriptableObject GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestScriptableObject Get(int key)
        {
            ...
            v = test.TestScriptableObject.DeserializeTestScriptableObject(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestScriptableObject this[int key] => this.Get(key);
