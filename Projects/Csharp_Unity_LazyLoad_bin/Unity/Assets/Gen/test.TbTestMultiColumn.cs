...
namespace cfg.test
{
    public partial class TbTestMultiColumn
    {
        ...
        public TbTestMultiColumn(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestMultiColumn> onLoad = null)
        {
        ...
        public test.TestMultiColumn GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestMultiColumn Get(int key)
        {
            ...
            v = test.TestMultiColumn.DeserializeTestMultiColumn(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestMultiColumn this[int key] => this.Get(key);
