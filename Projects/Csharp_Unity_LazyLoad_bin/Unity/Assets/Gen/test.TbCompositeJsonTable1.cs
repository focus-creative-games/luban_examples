...
namespace cfg.test
{
    public partial class TbCompositeJsonTable1
    {
        ...
        public TbCompositeJsonTable1(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.CompositeJsonTable1> onLoad = null)
        {
        ...
        public test.CompositeJsonTable1 GetOrDefault(int key) => this.Get(key) ?? default;
        public test.CompositeJsonTable1 Get(int key)
        {
            ...
            v = test.CompositeJsonTable1.DeserializeCompositeJsonTable1(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.CompositeJsonTable1 this[int key] => this.Get(key);
