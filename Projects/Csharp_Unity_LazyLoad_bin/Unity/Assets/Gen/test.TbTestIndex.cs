...
namespace cfg.test
{
    public partial class TbTestIndex
    {
        ...
        public TbTestIndex(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestIndex> onLoad = null)
        {
        ...
        public test.TestIndex GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestIndex Get(int key)
        {
            ...
            v = test.TestIndex.DeserializeTestIndex(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestIndex this[int key] => this.Get(key);
