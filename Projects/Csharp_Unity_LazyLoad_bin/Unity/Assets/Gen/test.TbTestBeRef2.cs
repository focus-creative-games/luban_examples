...
namespace cfg.test
{
    public partial class TbTestBeRef2
    {
        ...
        public TbTestBeRef2(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestBeRef> onLoad = null)
        {
        ...
        public test.TestBeRef GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestBeRef Get(int key)
        {
            ...
            v = test.TestBeRef.DeserializeTestBeRef(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestBeRef this[int key] => this.Get(key);
