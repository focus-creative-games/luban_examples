...
namespace cfg.test
{
    public partial class TbTestNull
    {
        ...
        public TbTestNull(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestNull> onLoad = null)
        {
        ...
        public test.TestNull GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestNull Get(int key)
        {
            ...
            v = test.TestNull.DeserializeTestNull(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestNull this[int key] => this.Get(key);
