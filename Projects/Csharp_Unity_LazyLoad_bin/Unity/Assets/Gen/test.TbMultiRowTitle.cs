...
namespace cfg.test
{
    public partial class TbMultiRowTitle
    {
        ...
        public TbMultiRowTitle(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.MultiRowTitle> onLoad = null)
        {
        ...
        public test.MultiRowTitle GetOrDefault(int key) => this.Get(key) ?? default;
        public test.MultiRowTitle Get(int key)
        {
            ...
            v = test.MultiRowTitle.DeserializeMultiRowTitle(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.MultiRowTitle this[int key] => this.Get(key);
