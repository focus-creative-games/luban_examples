...
namespace cfg.test
{
    public partial class TbDemoPrimitive
    {
        ...
        public TbDemoPrimitive(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.DemoPrimitiveTypesTable> onLoad = null)
        {
        ...
        public test.DemoPrimitiveTypesTable GetOrDefault(int key) => this.Get(key) ?? default;
        public test.DemoPrimitiveTypesTable Get(int key)
        {
            ...
            v = test.DemoPrimitiveTypesTable.DeserializeDemoPrimitiveTypesTable(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.DemoPrimitiveTypesTable this[int key] => this.Get(key);
