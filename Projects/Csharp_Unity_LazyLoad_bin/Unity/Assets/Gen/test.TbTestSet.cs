...
namespace cfg.test
{
    public partial class TbTestSet
    {
        ...
        public TbTestSet(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestSet> onLoad = null)
        {
        ...
        public test.TestSet GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestSet Get(int key)
        {
            ...
            v = test.TestSet.DeserializeTestSet(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestSet this[int key] => this.Get(key);
