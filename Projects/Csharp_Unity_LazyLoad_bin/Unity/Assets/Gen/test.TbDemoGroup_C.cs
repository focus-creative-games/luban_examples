...
namespace cfg.test
{
    public partial class TbDemoGroup_C
    {
        ...
        public TbDemoGroup_C(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.DemoGroup> onLoad = null)
        {
        ...
        public test.DemoGroup GetOrDefault(int key) => this.Get(key) ?? default;
        public test.DemoGroup Get(int key)
        {
            ...
            v = test.DemoGroup.DeserializeDemoGroup(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.DemoGroup this[int key] => this.Get(key);
