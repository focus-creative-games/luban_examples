...
namespace cfg.test
{
    public partial class TbDefineFromExcel2
    {
        ...
        public TbDefineFromExcel2(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,DefineFromExcel2> onLoad = null)
        {
        ...
        public DefineFromExcel2 GetOrDefault(int key) => this.Get(key) ?? default;
        public DefineFromExcel2 Get(int key)
        {
            ...
            v = DefineFromExcel2.DeserializeDefineFromExcel2(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public DefineFromExcel2 this[int key] => this.Get(key);
