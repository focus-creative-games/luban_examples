...
namespace cfg.test
{
    public partial class TbTestMapper
    {
        ...
        public TbTestMapper(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestMapper> onLoad = null)
        {
        ...
        public test.TestMapper GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestMapper Get(int key)
        {
            ...
            v = test.TestMapper.DeserializeTestMapper(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestMapper this[int key] => this.Get(key);
