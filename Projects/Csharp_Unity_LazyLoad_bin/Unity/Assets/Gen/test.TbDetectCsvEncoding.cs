...
namespace cfg.test
{
    public partial class TbDetectCsvEncoding
    {
        ...
        public TbDetectCsvEncoding(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.DetectEncoding> onLoad = null)
        {
        ...
        public test.DetectEncoding GetOrDefault(int key) => this.Get(key) ?? default;
        public test.DetectEncoding Get(int key)
        {
            ...
            v = test.DetectEncoding.DeserializeDetectEncoding(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.DetectEncoding this[int key] => this.Get(key);
