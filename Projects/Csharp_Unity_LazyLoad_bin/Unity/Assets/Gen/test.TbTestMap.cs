...
namespace cfg.test
{
    public partial class TbTestMap
    {
        ...
        public TbTestMap(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestMap> onLoad = null)
        {
        ...
        public test.TestMap GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestMap Get(int key)
        {
            ...
            v = test.TestMap.DeserializeTestMap(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestMap this[int key] => this.Get(key);
