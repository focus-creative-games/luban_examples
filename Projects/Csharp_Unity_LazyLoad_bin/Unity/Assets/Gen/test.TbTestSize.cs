...
namespace cfg.test
{
    public partial class TbTestSize
    {
        ...
        public TbTestSize(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestSize> onLoad = null)
        {
        ...
        public test.TestSize GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestSize Get(int key)
        {
            ...
            v = test.TestSize.DeserializeTestSize(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestSize this[int key] => this.Get(key);
