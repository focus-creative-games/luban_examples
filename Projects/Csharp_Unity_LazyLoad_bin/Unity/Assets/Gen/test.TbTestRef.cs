...
namespace cfg.test
{
    public partial class TbTestRef
    {
        ...
        public TbTestRef(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.TestRef> onLoad = null)
        {
        ...
        public test.TestRef GetOrDefault(int key) => this.Get(key) ?? default;
        public test.TestRef Get(int key)
        {
            ...
            v = test.TestRef.DeserializeTestRef(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.TestRef this[int key] => this.Get(key);
