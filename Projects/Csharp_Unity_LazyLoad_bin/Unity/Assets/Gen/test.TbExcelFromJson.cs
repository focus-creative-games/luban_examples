...
namespace cfg.test
{
    public partial class TbExcelFromJson
    {
        ...
        public TbExcelFromJson(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.ExcelFromJson> onLoad = null)
        {
        ...
        public test.ExcelFromJson GetOrDefault(int key) => this.Get(key) ?? default;
        public test.ExcelFromJson Get(int key)
        {
            ...
            v = test.ExcelFromJson.DeserializeExcelFromJson(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.ExcelFromJson this[int key] => this.Get(key);
