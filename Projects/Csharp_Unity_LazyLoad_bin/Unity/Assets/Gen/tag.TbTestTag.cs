...
namespace cfg.tag
{
    public partial class TbTestTag
    {
        ...
        public TbTestTag(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,tag.TestTag> onLoad = null)
        {
        ...
        public tag.TestTag GetOrDefault(int key) => this.Get(key) ?? default;
        public tag.TestTag Get(int key)
        {
            ...
            v = tag.TestTag.DeserializeTestTag(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public tag.TestTag this[int key] => this.Get(key);
