...
namespace cfg.test
{
    public partial class TbMultiRowRecord
    {
        ...
        public TbMultiRowRecord(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,test.MultiRowRecord> onLoad = null)
        {
        ...
        public test.MultiRowRecord GetOrDefault(int key) => this.Get(key) ?? default;
        public test.MultiRowRecord Get(int key)
        {
            ...
            v = test.MultiRowRecord.DeserializeMultiRowRecord(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public test.MultiRowRecord this[int key] => this.Get(key);
