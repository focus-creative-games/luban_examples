...
namespace cfg.l10n
{
    public partial class TbL10NDemo
    {
        ...
        public TbL10NDemo(ByteBuf _buf,string fileName, System.Func<string, int, int, ByteBuf> byteBufLoader)
        {
        ...
        public void LoadAll(System.Action<int,l10n.L10NDemo> onLoad = null)
        {
        ...
        public l10n.L10NDemo GetOrDefault(int key) => this.Get(key) ?? default;
        public l10n.L10NDemo Get(int key)
        {
            ...
            v = l10n.L10NDemo.DeserializeL10NDemo(buf);;
            _dataMap[key] = v;
            v.ResolveRef(_tables);
            return v;
        }
        public l10n.L10NDemo this[int key] => this.Get(key);
