...
public sealed partial class DefineFromExcel2 :  Bright.Config.BeanBase 
{
    ...
    {
        typeof(DefineFromExcel2).GetProperty("Id").SetValue(this, reloadData.Id);
        typeof(DefineFromExcel2).GetProperty("X1").SetValue(this, reloadData.X1);
        typeof(DefineFromExcel2).GetProperty("X5").SetValue(this, reloadData.X5);
        typeof(DefineFromExcel2).GetProperty("X6").SetValue(this, reloadData.X6);
        typeof(DefineFromExcel2).GetProperty("X8").SetValue(this, reloadData.X8);
        typeof(DefineFromExcel2).GetProperty("X10").SetValue(this, reloadData.X10);
        typeof(DefineFromExcel2).GetProperty("X13").SetValue(this, reloadData.X13);
        ...
        typeof(DefineFromExcel2).GetProperty("V2").SetValue(this, reloadData.V2);
        typeof(DefineFromExcel2).GetProperty("T1").SetValue(this, reloadData.T1);
        ...
        typeof(DefineFromExcel2).GetProperty("K8").SetValue(this, reloadData.K8);
        typeof(DefineFromExcel2).GetProperty("K9").SetValue(this, reloadData.K9);
    }
