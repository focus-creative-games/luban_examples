...
impl Tables {
    ...
    unsafe fn resolve_ref(&mut self) {
        let mut b = Box::from_raw(self.TbTestRef.as_ref() as *const crate::test::TbTestRef as *mut crate::test::TbTestRef);
...
use crate::prelude::RefDynamicBase;
...
impl DefineFromExcel2 {
    pub fn new(json: &serde_json::Value) -> Result<DefineFromExcel2, LubanError> {
        ...
        let mut v11 = None;
        if let Some(value) = json.get("v11") { v11 = Some(crate::vec3::new(&json["v11"])?); }
