...
{
    public SimpleParallel(JToken _buf)  : base(_buf) 
    {
        JObject _obj = _buf as JObject;
        FinishMode = (ai.EFinishMode)(int)_obj.GetValue("finish_mode");
        MainTask = ai.Task.DeserializeTask(_obj.GetValue("main_task"));
        BackgroundNode = ai.FlowNode.DeserializeFlowNode(_obj.GetValue("background_node"));
    }

    public static SimpleParallel DeserializeSimpleParallel(JToken _buf)
    {
