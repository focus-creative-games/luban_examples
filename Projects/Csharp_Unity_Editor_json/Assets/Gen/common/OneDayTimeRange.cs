...
public sealed class OneDayTimeRange :  Luban.EditorBeanBase 
{
    ...
    public override void Render()
    {
        ...
        UnityEditor.EditorGUILayout.LabelField("hour");
        startTime.hour = UnityEditor.EditorGUILayout.IntField(startTime.hour, GUILayout.Width(150));
        UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
        UnityEditor.EditorGUILayout.LabelField("minute");
        startTime.minute = UnityEditor.EditorGUILayout.IntField(startTime.minute, GUILayout.Width(150));
        UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
        UnityEditor.EditorGUILayout.LabelField("second");
        startTime.second = UnityEditor.EditorGUILayout.IntField(startTime.second, GUILayout.Width(150));
        ...
        UnityEditor.EditorGUILayout.LabelField("end_time", GUILayout.Width(100));
        {
            UnityEditor.EditorGUILayout.BeginVertical("Box");UnityEditor.EditorGUILayout.BeginHorizontal();
        UnityEditor.EditorGUILayout.LabelField("hour");
        endTime.hour = UnityEditor.EditorGUILayout.IntField(endTime.hour, GUILayout.Width(150));
        UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
        UnityEditor.EditorGUILayout.LabelField("minute");
        endTime.minute = UnityEditor.EditorGUILayout.IntField(endTime.minute, GUILayout.Width(150));
        UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
        UnityEditor.EditorGUILayout.LabelField("second");
        endTime.second = UnityEditor.EditorGUILayout.IntField(endTime.second, GUILayout.Width(150));
        UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        }
        UnityEditor.EditorGUILayout.EndHorizontal();
