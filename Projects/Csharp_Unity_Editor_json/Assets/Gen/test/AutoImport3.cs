...
public sealed class AutoImport3 :  Luban.EditorBeanBase 
{
    public AutoImport3()
    {
            x10 = "";
    ...
    public static AutoImport3 LoadJsonAutoImport3(JSONNode _json)
    {
        AutoImport3 obj = new test.AutoImport3();
        obj.LoadJson((JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonAutoImport3(AutoImport3 _obj, JSONNode _json)
    {
