...
public sealed partial class DefineFromExcel :  Bright.Config.EditorBeanBase 
{
    ...
    public static DefineFromExcel LoadJsonDefineFromExcel(SimpleJSON.JSONNode _json)
    {
        DefineFromExcel obj = new test.DefineFromExcel();
        obj.LoadJson((SimpleJSON.JSONObject)_json);
        return obj;
    }
        
    public static void SaveJsonDefineFromExcel(DefineFromExcel _obj, SimpleJSON.JSONNode _json)
    {
