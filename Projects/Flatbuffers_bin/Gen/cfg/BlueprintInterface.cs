...
public struct BlueprintInterface : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static BlueprintInterface GetRootAsBlueprintInterface(ByteBuffer _bb) { return GetRootAsBlueprintInterface(_bb, new BlueprintInterface()); }
  public static BlueprintInterface GetRootAsBlueprintInterface(ByteBuffer _bb, BlueprintInterface obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public BlueprintInterface __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<cfg.BlueprintInterface> CreateBlueprintInterface(FlatBufferBuilder builder,
    ...
    BlueprintInterface.AddMethods(builder, methodsOffset);
    BlueprintInterface.AddMethodsType(builder, methods_typeOffset);
    BlueprintInterface.AddParents(builder, parentsOffset);
    BlueprintInterface.AddParentsType(builder, parents_typeOffset);
    BlueprintInterface.AddDesc(builder, descOffset);
    BlueprintInterface.AddName(builder, nameOffset);
    return BlueprintInterface.EndBlueprintInterface(builder);
  }

  public static void StartBlueprintInterface(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<cfg.BlueprintInterface> EndBlueprintInterface(FlatBufferBuilder builder) {
    ...
    return new Offset<cfg.BlueprintInterface>(o);
  }
};
