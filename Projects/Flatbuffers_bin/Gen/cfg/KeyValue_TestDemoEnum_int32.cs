...
public struct KeyValue_TestDemoEnum_int32 : IFlatbufferObject
{
  ...
  public cfg.TestDemoEnum Key { get { int o = __p.__offset(4); return o != 0 ? (cfg.TestDemoEnum)__p.bb.GetInt(o + __p.bb_pos) : cfg.TestDemoEnum.__GENERATE_DEFAULT_VALUE; } }
  ...
  public static Offset<cfg.KeyValue_TestDemoEnum_int32> CreateKeyValue_TestDemoEnum_int32(FlatBufferBuilder builder,
      cfg.TestDemoEnum key = cfg.TestDemoEnum.__GENERATE_DEFAULT_VALUE,
      int value = 0) {
