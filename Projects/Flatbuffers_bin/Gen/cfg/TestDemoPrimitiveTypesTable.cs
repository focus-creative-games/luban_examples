...
public struct TestDemoPrimitiveTypesTable : IFlatbufferObject
{
  ...
  public cfg.Vector3? V3 { get { int o = __p.__offset(24); return o != 0 ? (cfg.Vector3?)(new cfg.Vector3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public cfg.Vector4? V4 { get { int o = __p.__offset(26); return o != 0 ? (cfg.Vector4?)(new cfg.Vector4()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public int T1 { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void AddV3(FlatBufferBuilder builder, Offset<cfg.Vector3> v3Offset) { builder.AddStruct(10, v3Offset.Value, 0); }
  public static void AddV4(FlatBufferBuilder builder, Offset<cfg.Vector4> v4Offset) { builder.AddStruct(11, v4Offset.Value, 0); }
  public static void AddT1(FlatBufferBuilder builder, int t1) { builder.AddInt(12, t1, 0); }
