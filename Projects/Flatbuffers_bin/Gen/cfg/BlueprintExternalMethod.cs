...
public struct BlueprintExternalMethod : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static BlueprintExternalMethod GetRootAsBlueprintExternalMethod(ByteBuffer _bb) { return GetRootAsBlueprintExternalMethod(_bb, new BlueprintExternalMethod()); }
  public static BlueprintExternalMethod GetRootAsBlueprintExternalMethod(ByteBuffer _bb, BlueprintExternalMethod obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public BlueprintExternalMethod __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<cfg.BlueprintExternalMethod> CreateBlueprintExternalMethod(FlatBufferBuilder builder,
    ...
    BlueprintExternalMethod.AddParameters(builder, parametersOffset);
    BlueprintExternalMethod.AddReturnType(builder, return_typeOffset);
    BlueprintExternalMethod.AddDesc(builder, descOffset);
    BlueprintExternalMethod.AddName(builder, nameOffset);
    BlueprintExternalMethod.AddIsStatic(builder, is_static);
    return BlueprintExternalMethod.EndBlueprintExternalMethod(builder);
  }

  public static void StartBlueprintExternalMethod(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<cfg.BlueprintExternalMethod> EndBlueprintExternalMethod(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 12);  // parameters
    return new Offset<cfg.BlueprintExternalMethod>(o);
  }
};
