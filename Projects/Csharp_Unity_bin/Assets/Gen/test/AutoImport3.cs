...
{
    public AutoImport3(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
        X1 = _buf.ReadBool();
        X5 = _buf.ReadLong();
        ...
        X14 = global::cfg.test.DemoDynamic.DeserializeDemoDynamic(_buf);
        X15 = global::cfg.test.Shape.DeserializeShape(_buf);
        V2 = ExternalTypeUtil.NewVector2(global::cfg.vec2.Deserializevec2(_buf));
        T1 = _buf.ReadLong();
        ...
        {int __n0 = _buf.ReadSize(); K2 = new int[__n0];for(var __index0 = 0 ; __index0 < __n0 ; __index0++) { int __e0;__e0 = _buf.ReadInt(); K2[__index0] = __e0;}}
        ...
        {int n0 = _buf.ReadSize(); K10 = new System.Collections.Generic.List<UnityEngine.Vector3>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { UnityEngine.Vector3 _e0;  _e0 = ExternalTypeUtil.NewVector3(global::cfg.vec3.Deserializevec3(_buf)); K10.Add(_e0);}}
        {int n0 = _buf.ReadSize(); K11 = new System.Collections.Generic.List<UnityEngine.Vector4>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { UnityEngine.Vector4 _e0;  _e0 = ExternalTypeUtil.NewVector4(global::cfg.vec4.Deserializevec4(_buf)); K11.Add(_e0);}}
        if(_buf.ReadBool()){ V11 = ExternalTypeUtil.NewVector3(global::cfg.vec3.Deserializevec3(_buf)); } else { V11 = null; }
    }

    public static AutoImport3 DeserializeAutoImport3(ByteBuf _buf)
    {
