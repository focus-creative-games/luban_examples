...
public partial class TbTestSize
{
    ...
    {
        int n = _buf.ReadSize();
        _dataMap = new System.Collections.Generic.Dictionary<int, test.TestSize>(n);
        _dataList = new System.Collections.Generic.List<test.TestSize>(n);
        for(int i = n ; i > 0 ; --i)
        {
            test.TestSize _v;
            _v = global::cfg.test.TestSize.DeserializeTestSize(_buf);
            _dataList.Add(_v);
