...
public sealed partial class ExcelFromJson : Luban.BeanBase
{
    public ExcelFromJson(ByteBuf _buf) 
    {
        ...
        {int __n0 = _buf.ReadSize(); K15 = new test.DemoDynamic[__n0];for(var __index0 = 0 ; __index0 < __n0 ; __index0++) { test.DemoDynamic __e0;__e0 = global::cfg.test.DemoDynamic.DeserializeDemoDynamic(_buf); K15[__index0] = __e0;}}
    }
