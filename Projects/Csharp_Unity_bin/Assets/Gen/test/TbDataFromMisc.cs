...
public partial class TbDataFromMisc
{
    ...
    {
        int n = _buf.ReadSize();
        _dataMap = new System.Collections.Generic.Dictionary<int, test.DemoType2>(n);
        _dataList = new System.Collections.Generic.List<test.DemoType2>(n);
        for(int i = n ; i > 0 ; --i)
        {
            test.DemoType2 _v;
            _v = global::cfg.test.DemoType2.DeserializeDemoType2(_buf);
            _dataList.Add(_v);
