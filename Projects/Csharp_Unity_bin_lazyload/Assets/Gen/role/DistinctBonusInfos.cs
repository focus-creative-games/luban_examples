...
public sealed partial class DistinctBonusInfos :  Bright.Config.BeanBase 
{
    public DistinctBonusInfos(ByteBuf _buf) 
    {
        ...
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);BonusInfo = new System.Collections.Generic.List<role.BonusInfo>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { role.BonusInfo _e0;  _e0 = role.BonusInfo.DeserializeBonusInfo(_buf); BonusInfo.Add(_e0);}}
        PostInit();
    }
