...
public sealed partial class LevelExpAttr :  Bright.Config.BeanBase 
{
    public LevelExpAttr(ByteBuf _buf) 
    {
        ...
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);ClothesAttrs = new System.Collections.Generic.List<int>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { int _e0;  _e0 = _buf.ReadInt(); ClothesAttrs.Add(_e0);}}
        PostInit();
    }
