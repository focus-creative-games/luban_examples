...
namespace cfg.test
{
    ...
    {
        public static TbCompositeJsonTable1 Instance { get; private set; }
        private bool _readAll = false;
        private Dictionary<int, test.CompositeJsonTable1> _dataMap;
        private List<test.CompositeJsonTable1> _dataList;
        public Dictionary<int, test.CompositeJsonTable1> DataMap
        {
            get
            {
                if(!_readAll)
        ...
        public List<test.CompositeJsonTable1> DataList
        {
            get
            {
                if(!_readAll)
