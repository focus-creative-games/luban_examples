...
namespace cfg.test
{
    ...
    public partial class TbDemoPrimitive
    {
        ...
        public List<test.DemoPrimitiveTypesTable> DataList
        {
            get
            {
                if(!_readAll)
