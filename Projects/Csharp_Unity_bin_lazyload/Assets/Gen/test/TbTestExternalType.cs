...
namespace cfg.test
{
    ...
    {
        public static TbTestExternalType Instance { get; private set; }
        private bool _readAll = false;
        private Dictionary<int, test.TestExternalType> _dataMap;
        private List<test.TestExternalType> _dataList;
        public Dictionary<int, test.TestExternalType> DataMap
        {
            get
            {
                if(!_readAll)
        ...
        public List<test.TestExternalType> DataList
        {
            get
            {
                if(!_readAll)
