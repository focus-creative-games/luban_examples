...
namespace cfg.test
{
    ...
    {
        public static TbCompositeJsonTable2 Instance { get; private set; }
        private bool _readAll = false;
        private Dictionary<int, test.CompositeJsonTable2> _dataMap;
        private List<test.CompositeJsonTable2> _dataList;
        public Dictionary<int, test.CompositeJsonTable2> DataMap
        {
            get
            {
                if(!_readAll)
        ...
        public List<test.CompositeJsonTable2> DataList
        {
            get
            {
                if(!_readAll)
