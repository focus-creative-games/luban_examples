...
public sealed partial class DefineFromExcelOne :  Bright.Config.BeanBase 
{
    public DefineFromExcelOne(ByteBuf _buf) 
    {
        ...
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);Icons = new System.Collections.Generic.List<string>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { string _e0;  _e0 = _buf.ReadString(); Icons.Add(_e0);}}
        PostInit();
    }
