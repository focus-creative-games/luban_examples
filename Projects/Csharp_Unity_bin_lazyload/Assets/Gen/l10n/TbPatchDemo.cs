...
namespace cfg.l10n
{
    ...
    {
        public static TbPatchDemo Instance { get; private set; }
        private bool _readAll = false;
        private Dictionary<int, l10n.PatchDemo> _dataMap;
        private List<l10n.PatchDemo> _dataList;
        public Dictionary<int, l10n.PatchDemo> DataMap
        {
            get
            {
                if(!_readAll)
        ...
        public List<l10n.PatchDemo> DataList
        {
            get
            {
                if(!_readAll)
