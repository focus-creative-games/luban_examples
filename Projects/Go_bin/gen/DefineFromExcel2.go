...
func NewDefineFromExcel2(_buf *luban.ByteBuf) (_v *DefineFromExcel2, err error) {
    ...
    {_v.K10 = make([]*vector3, 0); var _n_ int; if _n_, err = _buf.ReadSize(); err != nil { err = errors.New("error"); return}; for i := 0 ; i < _n_ ; i++ { var _e_ *vector3; { if _e_, err = Newvector3(_buf); err != nil { err = errors.New("error"); return } }; _v.K10 = append(_v.K10, _e_) } }
    {_v.K11 = make([]*vector4, 0); var _n_ int; if _n_, err = _buf.ReadSize(); err != nil { err = errors.New("error"); return}; for i := 0 ; i < _n_ ; i++ { var _e_ *vector4; { if _e_, err = Newvector4(_buf); err != nil { err = errors.New("error"); return } }; _v.K11 = append(_v.K11, _e_) } }
    return
}
