...
func (_v *TestDefineFromExcel)Serialize(_buf *serialization.ByteBuf) {
    // not support
}

func (_v *TestDefineFromExcel)Deserialize(_buf *serialization.ByteBuf) (err error) {
...
func DeserializeTestDefineFromExcel(_buf *serialization.ByteBuf) (*TestDefineFromExcel, error) {
