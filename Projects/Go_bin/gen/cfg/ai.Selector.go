...
func (_v *AiSelector)Serialize(_buf *serialization.ByteBuf) {
    // not support
}

func (_v *AiSelector)Deserialize(_buf *serialization.ByteBuf) (err error) {
...
func DeserializeAiSelector(_buf *serialization.ByteBuf) (*AiSelector, error) {
    v := &AiSelector{}
