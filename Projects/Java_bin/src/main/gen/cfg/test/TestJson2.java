...
public final class TestJson2 {
    public TestJson2(ByteBuf _buf) { 
        ...
        {int n = Math.min(_buf.readSize(), _buf.size());m4 = new java.util.HashMap<String, cfg.test.DemoType1>(n * 3 / 2);for(var i = 0 ; i < n ; i++) { String _k;  _k = _buf.readString(); cfg.test.DemoType1 _v;  _v = new cfg.test.DemoType1(_buf);     m4.put(_k, _v);}}
    }
