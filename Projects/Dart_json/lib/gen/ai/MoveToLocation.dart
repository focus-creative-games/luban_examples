...
import '/gen/ai/Task.dart';
 ...
 class MoveToLocation extends Task
{
    MoveToLocation(
    {
    required super.id, 
    ...
    factory MoveToLocation.deserialize(dynamic _buf){
        final id;
        id = _buf['id'] as int;
        final node_name;
    ...
    static final int __ID__ = -969953113;
     @override
    ...
    @override
    String toString() {
        return 'MoveToLocation(id:$id, node_name:$node_name, decorators:$decorators, services:$services, ignore_restart_self:$ignore_restart_self, acceptable_radius:$acceptable_radius, )';
    }
}
