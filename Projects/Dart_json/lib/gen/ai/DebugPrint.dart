 ...
 class DebugPrint extends Task
{
    ...
    factory DebugPrint.deserialize(dynamic _buf){
        final id;
        id = _buf['id'] as int;
        final node_name;
    ...
    final String text;
    static final int __ID__ = 1357409728;
     @override
    ...
    @override
    String toString() {
        return 'DebugPrint(id:$id, node_name:$node_name, decorators:$decorators, services:$services, ignore_restart_self:$ignore_restart_self, text:$text, )';
    }
}
