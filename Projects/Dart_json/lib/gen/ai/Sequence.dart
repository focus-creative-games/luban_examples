...
import '/gen/ai/ComposeNode.dart';
 ...
 class Sequence extends ComposeNode
{
    Sequence(
    {
    required super.id, 
    ...
    factory Sequence.deserialize(dynamic _buf){
        final id;
        id = _buf['id'] as int;
        final node_name;
    ...
    static final int __ID__ = -1789006105;
     @override
    ...
    @override
    String toString() {
        return 'Sequence(id:$id, node_name:$node_name, decorators:$decorators, services:$services, children:$children, )';
    }
}
