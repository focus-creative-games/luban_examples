 ...
 class AutoImport2 
{
    ...
    factory AutoImport2.deserialize(dynamic _buf){
        final id;
        id = _buf['id'] as int;
        final x1;
        x1 = _buf['x1'] as bool;
    ...
    final List<vec4> k11;
    final vec3? v11;
    static final int __ID__ = 417472770;
    ...
    @override
    String toString() {
        return 'AutoImport2(id:$id, x1:$x1, x5:$x5, x6:$x6, x8:$x8, x10:$x10, x13:$x13, x13_2:$x13_2, x14:$x14, x15:$x15, v2:$v2, t1:$t1, k1:$k1, k2:$k2, k8:$k8, k9:$k9, k10:$k10, k11:$k11, v11:$v11, )';
    }
}
