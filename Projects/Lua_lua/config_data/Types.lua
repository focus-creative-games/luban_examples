...
---@field public value int
beans['item.ClothesProp'] =
{
    { name='prop_enum', type='item.EClothesPropertyType'},
    { name='value', type='int'},
}
