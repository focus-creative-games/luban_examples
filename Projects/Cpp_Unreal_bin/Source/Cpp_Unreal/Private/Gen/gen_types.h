...
typedef struct t_TbMultiUnionIndexList_MultiKey
{
     ::bright::int32 id1;
     ::bright::int64 id2;
     ::bright::String id3;
    bool operator==(const t_TbMultiUnionIndexList_MultiKey& stOther) const
	{
        bool bEqual = true;
        bEqual = bEqual && (stOther.id1 == id1);
        bEqual = bEqual && (stOther.id2 == id2);
        bEqual = bEqual && (stOther.id3 == id3);
        return bEqual;
    }
}t_TbMultiUnionIndexList_MultiKey;

typedef struct t_TbMultiUnionIndexList_MultiKey_HashFunc
{
	std::size_t operator()(const t_TbMultiUnionIndexList_MultiKey& stMK) const
	{
        std::size_t sHash = 0;
        sHash ^= std::hash<::bright::int32>()(stMK.id1);            
        sHash ^= std::hash<::bright::int64>()(stMK.id2);            
        sHash ^= std::hash<::bright::String>()(stMK.id3);            
		return sHash;
	}
}t_TbMultiUnionIndexList_MultiKey_HashFunc;
...
class TbMultiUnionIndexList
{
    private:
        ...
        ::bright::HashMapMultiKey<t_TbMultiUnionIndexList_MultiKey, ::bright::SharedPtr<test::MultiUnionIndexList>, t_TbMultiUnionIndexList_MultiKey_HashFunc> _dataMap;
        ...
        {        
            ...
            for(; n > 0 ; --n)
            {
                ...
                _dataList.push_back(_v);
                t_TbMultiUnionIndexList_MultiKey stKey;
                stKey.id1 = _v->id1;
                stKey.id2 = _v->id2;
                stKey.id3 = _v->id3;
                _dataMap[stKey] = _v;
        ...
        ::bright::HashMapMultiKey<t_TbMultiUnionIndexList_MultiKey, ::bright::SharedPtr<test::MultiUnionIndexList>, t_TbMultiUnionIndexList_MultiKey_HashFunc>& getDataMap()
        {
            return _dataMap;
        }
        test::MultiUnionIndexList* getRaw(t_TbMultiUnionIndexList_MultiKey& key)
        {
            auto it = _dataMap.find(key);
            return it != _dataMap.end() ? it->second.get() : nullptr;
        }
        ::bright::SharedPtr<test::MultiUnionIndexList> get(t_TbMultiUnionIndexList_MultiKey& key)
        {
            auto it = _dataMap.find(key);
            return it != _dataMap.end() ? it->second : nullptr;
        }
