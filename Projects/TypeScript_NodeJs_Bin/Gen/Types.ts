...
export  class DateTimeRange  {
    ...
    constructor(_buf_: ByteBuf) {
        if(_buf_.ReadBool()) { this.startTime = _buf_.ReadLongAsNumber() } else { this.startTime = undefined }
        if(_buf_.ReadBool()) { this.endTime = _buf_.ReadLongAsNumber() } else { this.endTime = undefined }
    }
...
export  class MultiRowTitle  {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        if(_buf_.ReadBool()) { this.x20 = new test.H2(_buf_) } else { this.x20 = undefined }
...
export  class TestRef  {
    ...
    resolve(_tables: Map<string, any>) {
        ...
        this.x4_Ref = (_tables.get('tag.TbTestTag') as tag.TbTestTag).get(this.x4)!
        if (this.s1 != null) { this.s1.resolve(_tables);}
    }
}
...
export  abstract  class RefDynamicBase  {
    ...
    resolve(_tables: Map<string, any>) {
        this.x_Ref = (_tables.get('test.TbTestBeRef') as test.TbTestBeRef).get(this.x)!
    }
}
...
export  class DefineFromExcel  {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        this.t1 = _buf_.ReadLongAsNumber()
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k1 = new Int32Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.k1[i] = _e } }
        { let n = Math.min(_buf_.ReadSize(), _buf_.Size); this.k2 = new Int32Array(n); for(let i = 0 ; i < n ; i++) { let _e :number;_e = _buf_.ReadInt(); this.k2[i] = _e } }
        { this.k8 = new Map<number, number>(); for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _k:number; _k = _buf_.ReadInt(); let _v:number; _v = _buf_.ReadInt(); this.k8.set(_k, _v);  } }
        { this.k9 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.DemoE2; _e = new test.DemoE2(_buf_); this.k9.push(_e) } }
        { this.k10 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :Vector3; _e = Vector3.deserializeFrom(_buf_); this.k10.push(_e) } }
        { this.k11 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :Vector4; _e = Vector4.deserializeFrom(_buf_); this.k11.push(_e) } }
    }
...
export class TbDefineFromExcelOne {
     ...
     */
     ...
     get e2(): test.DemoE2 { return this._data.e2 }
     get icons(): string[] { return this._data.icons }
...
export  class DefineFromExcelOne  {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        this.e2 = new test.DemoE2(_buf_)
        { this.icons = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :string; _e = _buf_.ReadString(); this.icons.push(_e) } }
    }
    ...
    readonly e2: test.DemoE2
    readonly icons: string[]

    resolve(_tables: Map<string, any>) {
        if (this.e2 != null) { this.e2.resolve(_tables);}
    }
}
...
export  class TestSep  {
    ...
    constructor(_buf_: ByteBuf) {
        this.id = _buf_.ReadInt()
         _buf_.ReadString(); this.x1 = _buf_.ReadString()
        this.x2 = new test.SepBean1(_buf_)
        this.x3 = new test.SepVector(_buf_)
        { this.x4 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.SepVector; _e = new test.SepVector(_buf_); this.x4.push(_e) } }
        { this.x5 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.SepBean1; _e = new test.SepBean1(_buf_); this.x5.push(_e) } }
        { this.x6 = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.SepBean1; _e = new test.SepBean1(_buf_); this.x6.push(_e) } }
    }
...
export  class TestExternalType  {
    ...
    constructor(_buf_: ByteBuf) {
        ...
        { this.audioTypes = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.AudioType; _e = _buf_.ReadInt(); this.audioTypes.push(_e) } }
        { this.colors = []; for(let i = 0, n = _buf_.ReadSize() ; i < n ; i++) { let _e :test.Color; _e = new test.Color(_buf_); this.colors.push(_e) } }
    }

    readonly id: number
    readonly audioType: test.AudioType
    readonly color: test.Color
    readonly audioTypes: test.AudioType[]
    readonly colors: test.Color[]

    resolve(_tables: Map<string, any>) {
        if (this.color != null) { this.color.resolve(_tables);}
        for(let _e of this.colors) { if (_e != null ) {_e.resolve(_tables);} }
    }
}
...
export class TbTestDesc {
    ...
    get(index: number): test.TestDesc | undefined { return this._dataList[index] }
