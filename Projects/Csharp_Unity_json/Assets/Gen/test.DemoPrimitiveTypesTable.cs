...
public sealed partial class DemoPrimitiveTypesTable : Luban.BeanBase
{
    public DemoPrimitiveTypesTable(JSONNode _buf) 
    {
        ...
        { if(!_buf["v3"].IsObject) { throw new SerializationException(); }  V3 = vector3.Deserializevector3(_buf["v3"]);  }
        { if(!_buf["v4"].IsObject) { throw new SerializationException(); }  V4 = vector4.Deserializevector4(_buf["v4"]);  }
