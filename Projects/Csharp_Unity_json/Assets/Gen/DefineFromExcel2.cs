...
public sealed partial class DefineFromExcel2 : Luban.BeanBase
{
    public DefineFromExcel2(JSONNode _buf) 
    {
        ...
        { if(!_buf["v2"].IsObject) { throw new SerializationException(); }  V2 = vector2.Deserializevector2(_buf["v2"]);  }
        ...
        { var __json0 = _buf["k10"]; if(!__json0.IsArray) { throw new SerializationException(); } K10 = new System.Collections.Generic.List<vector3>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { vector3 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = vector3.Deserializevector3(__e0);  }  K10.Add(__v0); }   }
        { var __json0 = _buf["k11"]; if(!__json0.IsArray) { throw new SerializationException(); } K11 = new System.Collections.Generic.List<vector4>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { vector4 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = vector4.Deserializevector4(__e0);  }  K11.Add(__v0); }   }
    }
