...
var ItemTbItemLoader func(*ItemItem)
var ItemTbItemPostLoader func([]*ItemItem)
...
func NewItemTbItem(_buf []map[string]interface{}) (*ItemTbItem, error) {
	...
	if ItemTbItemPostLoader != nil {
		ItemTbItemPostLoader(_dataList)
	}
