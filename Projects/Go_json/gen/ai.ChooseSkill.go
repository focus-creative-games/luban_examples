...
func NewAiChooseSkill(_buf map[string]interface{}) (_v *AiChooseSkill, err error) {
    ...
    { var _ok_ bool; var __json_result_skill_id_key__ interface{}; if __json_result_skill_id_key__, _ok_ = _buf["result_skill_id_key"]; !_ok_ || __json_result_skill_id_key__ == nil { err = errors.New("result_skill_id_key error"); return } else { var __x__ string;  {  if __x__, _ok_ = __json_result_skill_id_key__.(string); !_ok_ { err = errors.New("__x__ error"); return } }; _v.ResultSkillIdKey = __x__ }}
    return
}
