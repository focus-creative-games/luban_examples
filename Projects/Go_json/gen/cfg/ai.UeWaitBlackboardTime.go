...
func (_v *AiUeWaitBlackboardTime)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeAiUeWaitBlackboardTime(_buf map[string]interface{}) (*AiUeWaitBlackboardTime, error) {
