...
func (_v *TestMultiUnionIndexList)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeTestMultiUnionIndexList(_buf map[string]interface{}) (*TestMultiUnionIndexList, error) {
