...
func (_v *BlueprintExternalMethod)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeBlueprintExternalMethod(_buf map[string]interface{}) (*BlueprintExternalMethod, error) {
