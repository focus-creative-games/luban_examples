...
func (_v *AiUeBlackboard)Deserialize(_buf map[string]interface{}) (err error) {
    ...
    { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = _buf["key_query"].(map[string]interface{}); !_ok_ { err = errors.New("key_query error"); return }; if _v.KeyQuery, err = DeserializeAiKeyQueryOperator(_x_); err != nil { return } }
    return
}

func DeserializeAiUeBlackboard(_buf map[string]interface{}) (*AiUeBlackboard, error) {
    v := &AiUeBlackboard{}
