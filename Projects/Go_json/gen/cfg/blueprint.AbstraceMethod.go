...
func (_v *BlueprintAbstraceMethod)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeBlueprintAbstraceMethod(_buf map[string]interface{}) (*BlueprintAbstraceMethod, error) {
