...
func (_v *AiSimpleParallel)Deserialize(_buf map[string]interface{}) (err error) {
    ...
    { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = _buf["main_task"].(map[string]interface{}); !_ok_ { err = errors.New("main_task error"); return }; if _v.MainTask, err = DeserializeAiTask(_x_); err != nil { return } }
    { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = _buf["background_node"].(map[string]interface{}); !_ok_ { err = errors.New("background_node error"); return }; if _v.BackgroundNode, err = DeserializeAiFlowNode(_x_); err != nil { return } }
    return
}

func DeserializeAiSimpleParallel(_buf map[string]interface{}) (*AiSimpleParallel, error) {
    v := &AiSimpleParallel{}
