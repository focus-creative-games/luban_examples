...
func (_v *AiMoveToRandomLocation)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeAiMoveToRandomLocation(_buf map[string]interface{}) (*AiMoveToRandomLocation, error) {
