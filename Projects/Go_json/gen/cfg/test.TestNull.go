...
func (_v *TestTestNull)Deserialize(_buf map[string]interface{}) (err error) {
    ...
    { var _ok_ bool; var __json_x4__ interface{}; if __json_x4__, _ok_ = _buf["x4"]; !_ok_ || __json_x4__ == nil { return } else { var __x__ interface{};  { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = __json_x4__.(map[string]interface{}); !_ok_ { err = errors.New("__x__ error"); return }; if __x__, err = DeserializeTestDemoDynamic(_x_); err != nil { return } }; _v.X4 = __x__ }}
