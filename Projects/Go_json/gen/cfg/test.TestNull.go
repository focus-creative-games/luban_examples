...
func (_v *TestTestNull)Deserialize(_buf map[string]interface{}) (err error) {
    ...
    { var _ok_ bool; var __json_x3__ interface{}; if __json_x3__, _ok_ = _buf["x3"]; !_ok_ || __json_x3__ == nil { _v.X3 = nil } else { var __x__ *TestDemoType1;  { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = __json_x3__.(map[string]interface{}); !_ok_ { err = errors.New("__x__ error"); return }; if __x__, err = DeserializeTestDemoType1(_x_); err != nil { return } }; _v.X3 = __x__ }}
    { var _ok_ bool; var __json_x4__ interface{}; if __json_x4__, _ok_ = _buf["x4"]; !_ok_ || __json_x4__ == nil { _v.X4 = nil } else { var __x__ interface{};  { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = __json_x4__.(map[string]interface{}); !_ok_ { err = errors.New("__x__ error"); return }; if __x__, err = DeserializeTestDemoDynamic(_x_); err != nil { return } }; _v.X4 = __x__ }}
    ...
    { var _ok_ bool; var __json_s2__ interface{}; if __json_s2__, _ok_ = _buf["s2"]; !_ok_ || __json_s2__ == nil { _v.S2 = nil } else { var __x__ string;  {var _ok_ bool; var __json_text__ map[string]interface{}; if __json_text__, _ok_ = __json_s2__.(map[string]interface{}) ; !_ok_ { err = errors.New("__x__ error"); return };   {  if _, _ok_ = __json_text__["key"].(string); !_ok_ { err = errors.New("_ error"); return } }; {  if __x__, _ok_ = __json_text__["text"].(string); !_ok_ { err = errors.New("__x__ error"); return } } }; _v.S2 = &__x__ }}
    return
}

func DeserializeTestTestNull(_buf map[string]interface{}) (*TestTestNull, error) {
    v := &TestTestNull{}
