...
func (_v *TestDemoGroup)Deserialize(_buf map[string]interface{}) (err error) {
    ...
    { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = _buf["x5"].(map[string]interface{}); !_ok_ { err = errors.New("x5 error"); return }; if _v.X5, err = DeserializeTestInnerGroup(_x_); err != nil { return } }
    return
}

func DeserializeTestDemoGroup(_buf map[string]interface{}) (*TestDemoGroup, error) {
    v := &TestDemoGroup{}
