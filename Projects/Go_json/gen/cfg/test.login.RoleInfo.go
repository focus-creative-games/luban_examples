...
func (_v *TestLoginRoleInfo)Deserialize(_buf map[string]interface{}) (err error) {
...
func DeserializeTestLoginRoleInfo(_buf map[string]interface{}) (*TestLoginRoleInfo, error) {
    v := &TestLoginRoleInfo{}
