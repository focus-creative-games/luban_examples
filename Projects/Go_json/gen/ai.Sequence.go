...
func NewAiSequence(_buf map[string]interface{}) (_v *AiSequence, err error) {
    ...
    ; _v.Services = __x__ }}
    { var _ok_ bool; var __json_children__ interface{}; if __json_children__, _ok_ = _buf["children"]; !_ok_ || __json_children__ == nil { err = errors.New("children error"); return } else { var __x__ []interface{};  {
                    var _arr0_ []interface{}
                    var _ok0_ bool
                    if _arr0_, _ok0_ = (__json_children__).([]interface{}); !_ok0_ { err = errors.New("__x__ error"); return }
    
                    __x__ = make([]interface{}, 0, len(_arr0_))
                    
                    for _, _e0_ := range _arr0_ {
                        var _list_v0_ interface{}
                        { var _ok_ bool; var _x_ map[string]interface{}; if _x_, _ok_ = _e0_.(map[string]interface{}); !_ok_ { err = errors.New("_list_v0_ error"); return }; if _list_v0_, err = NewAiFlowNode(_x_); err != nil { return } }
                        __x__ = append(__x__, _list_v0_)
                    }
                }
    ; _v.Children = __x__ }}
