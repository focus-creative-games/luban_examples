...
const TypeId_AutoImport1 = -2092142499

func (*AutoImport1) GetTypeId() int32 {
    return -2092142499
}

func NewAutoImport1(_buf map[string]interface{}) (_v *AutoImport1, err error) {
    _v = &AutoImport1{}
